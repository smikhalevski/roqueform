...
describe('get', () => {
  ...
  test('returns an array of booleans for a single checkbox for "booleanArray" format', () => {
    ...
    expect(accessor.get([createElement('input', { type: 'checkbox', checked: false, value: 'aaa' })])).toEqual([false]);
  });
  ...
  test('returns an array of values for a single checkbox for "valueArray" format', () => {
    ...
    expect(accessor.get([createElement('input', { type: 'checkbox', checked: true, value: 'aaa' })])).toEqual(['aaa']);
